...
class Device:
    ...
    def __init__(self, name, location , status = 'ON') -> str:
        self._name =  name
...
class Light(Device):
    ...
    def __init__(self, name, location, brightness,color,status='ON') -> str:
...
class Thermostat(Device):
    ...
    def __init__(self, name, location,urrent_temperature,target_temperature, status='ON') -> str:
        super().__init__(name, location, status)
        self._current_temperature = urrent_temperature
...
class SmartTV(Device):
    __slots__ = ("_channel")
    def __init__(self, name, location,channel,status='ON',) -> str:
        super().__init__(name, location, status)
